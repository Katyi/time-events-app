import { TimeIntervalsProps } from '@/globals';
import React, { useEffect, useRef } from 'react';
import getActualPointIndex from '@/utils/time/getActualPointIndex';
import getNearestPointIndex from '@/utils/time/getNearestPointIndex';
import changePointZPosition from '@/utils/time/changePointZPosition';
import hidePoint from '@/utils/time/hidePoint';
import rotatePoints from '@/utils/time/rotatePoints';
import showPoint from '@/utils/time/showPoint';
import showPointLabel from '@/utils/time/showPointLabel';
import matrixToDegrees from '@/utils/time/matrixToDegrees';
  ...
  return (
    <>
      <div className="time-intervals" ref={ancestorRef}>
        <Years startYear={startYear} lastYear={lastYear} />
